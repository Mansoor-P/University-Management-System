SET SQL_SAFE_UPDATES=1;  -- this is for deleting the data in the table when the error comes like your using safe mode 
...
create table login  (username varchar(220),
...
create table studentleave(rollno varchar(20), 
date varchar(50),
 duration varchar(20)
 );

create table teacherleave(empId varchar(20),
 date varchar(50), 
 duration varchar(20)
 );
...
create table fee(course varchar(20),
...
insert into fee values("BTech", "48000", "43000","43000","43000","43000","43000","50000","50000");
...
insert into fee values("Bcom", "22000", "20000","20000","20000","","","","");
...
create table collegefee(rollno varchar(20),
 course varchar(20),
 branch varchar(20), 
 semester varchar(20),
 total varchar(20)
